...
But it does have a ring of truth to it. Especially for algorithms I quite enjoy writing lens-y, state-y, backtacking-y, pseudo-imperative code. This post came from an [egg](https://github.com/egraphs-good/egg/), and me writing a naive e-graph implementation in Haskell to figure out how it works.

Here is a tiny function which fixes an invariant, namely some lists being normalized and sorted.  
This implementation is nominally pure - a State monad carrying nested maps - to work as a baseline for something more efficient.
...
Here is an example of what monadic lenses could do, and this definitely can't:
